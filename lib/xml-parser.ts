...
This file implements xml parser. Its recommended not to go into deep details of this file as they are
all basic parsing functions.
These parsing functions are used by server request etc for parsing xml data
####################################################################################################
 */
