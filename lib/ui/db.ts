...
This  file contains db functions (CRUD) which are used by genieacs-ui server apis to entertain
requests.

Note another db.ts file in main lib folder implemetns functions used by cwmp-server
####################################################################################################
 */
