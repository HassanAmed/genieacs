...
/**
 * @summary function to create rpc response (a function is triggered based on request from switch-cases)
 * Implementations of functions are in this file in uppersection
