...
This  file implements functions to set/get network configuration for all servers. It has all default
configuration and methods used by other files to get configurations from environmnet variables. 
