...
This  file implements function that are performed on device by cwmp-server like set function sets
attributes of device, unpack function unpacks device attributes etc. These function are performed 
on device when making connection/connected with them.
####################################################################################################
 */
