...
This file imports all the components files from component folder(these component files implement 
small components like container etc) and contextify them all
...
//Contextifying  is a metadata tagger that performs text and content enrichment.
