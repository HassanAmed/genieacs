...
Filter-components used when we filter any resource for example when click only online devices in 
pie chart it will filer only devices that are online for you
